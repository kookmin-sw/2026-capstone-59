...
REQUIRED_STEP_DATA: list[dict] = [
        ...
        "default_dictionary": [
            {
                ...
                "definition": "해결하려는 문제를 구체적·측정 가능하게 서술한 한두 문장의 선언문",
            },
            {
                "term": "근본 원인 (Root Cause)",
                "definition": "표면적 증상 뒤에 있는 실제 문제의 원인",
            },
            {
                "term": "5 Whys",
                "definition": "'왜?'를 반복해 문제의 핵심 원인까지 파고드는 분석 기법",
            },
            {
                "term": "Pain Point",
                "definition": "사용자가 현재 경험하는 불편·불만족 지점",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                "term": "페르소나 (Persona)",
                "definition": "타겟 사용자를 대표하는 가상 인물 프로필",
            },
            {
                "term": "공감 지도 (Empathy Map)",
                "definition": "사용자의 생각·감정·행동을 시각화한 프레임워크",
            },
            {
                "term": "사용자 세그먼트",
                "definition": "공통된 특성이나 필요를 가진 사용자 집단",
            },
            {
                "term": "사용자 검증 (User Validation)",
                "definition": "가설로 만든 페르소나를 실제 사용자와의 접촉으로 확인하는 활동",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "제품·서비스가 사용자에게 제공하는 핵심 혜택과 차별점",
            },
            {
                "term": "MVP (Minimum Viable Product)",
                "definition": "핵심 가치를 검증하기 위한 최소 기능만 갖춘 초기 제품",
            },
            {
                "term": "Blue Ocean",
                "definition": "경쟁이 없거나 미개척된 새로운 시장 공간",
            },
            {
                "term": "엘리베이터 피치",
                "definition": "30~60초 안에 아이디어를 설득력 있게 전달하는 짧은 발표",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "아이디어나 기술의 실현 가능성을 검증하기 위한 소규모 시험 구현",
            },
            {
                "term": "기술 스파이크 (Technical Spike)",
                "definition": "불확실한 기술 요소를 탐색·검증하는 짧은 실험적 개발 작업",
            },
            {
                "term": "WBS (Work Breakdown Structure)",
                "definition": "프로젝트 전체 작업을 계층적으로 세분화한 구조",
            },
            {
                "term": "SWOT 분석",
                "definition": "강점·약점·기회·위협을 분석해 전략을 도출하는 프레임워크",
            },
        ],
    },
    # ── Stage 2: 프로젝트 계획 ────────────────────────────────────────────
    {
        ...
        "default_dictionary": [
            {
                "term": "마일스톤 (Milestone)",
                "definition": "프로젝트의 주요 완료 지점을 나타내는 기준점",
            },
            {
                "term": "간트 차트 (Gantt Chart)",
                "definition": "작업의 일정과 진행 상황을 시각화한 막대형 차트",
            },
            {
                "term": "스프린트 (Sprint)",
                "definition": "애자일 방법론에서 2주 내외의 짧은 개발 사이클",
            },
            {
                "term": "공수 추정 (Effort Estimation)",
                "definition": "작업 완료에 필요한 시간·인력을 사전에 예측하는 활동",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                "term": "RACI 매트릭스",
                "definition": "작업별 역할(실행·책임·협의·공유)을 명확히 정의한 책임 분담 표",
            },
            {
                "term": "오너십 (Ownership)",
                "definition": "특정 기능·영역에 대한 책임과 결정 권한을 갖는 것",
            },
            {
                "term": "스크럼 마스터",
                "definition": "팀의 애자일 프로세스를 촉진·관리하는 역할",
            },
            {
                "term": "코드 오너 (Code Owner)",
                "definition": "특정 코드 영역의 변경을 검토·승인할 책임이 있는 사람",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                "term": "리스크 (Risk)",
                "definition": "프로젝트 목표 달성에 부정적 영향을 줄 수 있는 불확실한 사건",
            },
            {
                "term": "리스크 매트릭스",
                "definition": "리스크를 발생 가능성과 영향도로 평가해 우선순위를 정하는 도구",
            },
            {
                "term": "완화 전략 (Mitigation Strategy)",
                "definition": "리스크가 발생할 가능성을 줄이거나 영향을 최소화하는 방안",
            },
            {
                "term": "Pre-mortem",
                "definition": "프로젝트 실패를 미리 가정해 잠재 문제를 사전에 발굴하는 기법",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "프로젝트에서 사용하는 언어·프레임워크·인프라의 조합",
            },
            {
                "term": "GitHub Flow",
                "definition": "메인 브랜치와 피처 브랜치만 사용하는 단순한 Git 협업 전략",
            },
            {
                "term": "CI/CD",
                "definition": "코드 변경을 자동으로 빌드·테스트·배포하는 지속적 통합/배포 파이프라인",
            },
            {
                "term": "컨테이너 (Container)",
                "definition": "애플리케이션과 실행 환경을 패키징해 어디서나 동일하게 실행하는 기술 (Docker 등)",
            },
        ],
    },
    # ── Stage 3: 요구사항 정의 ────────────────────────────────────────────
        ...
        "default_dictionary": [
            {
                ...
                "definition": "시스템이 갖춰야 할 기능·조건·특성에 대한 명세",
            },
            {
                "term": "사용자 스토리 (User Story)",
                "definition": "사용자 관점에서 원하는 기능을 서술한 짧은 문장",
            },
            {
                "term": "유스케이스 (Use Case)",
                "definition": "사용자와 시스템 간의 상호작용 시나리오를 구조화한 명세",
            },
            {
                "term": "이해관계자 (Stakeholder)",
                "definition": "프로젝트 결과에 영향을 받거나 영향을 주는 모든 사람",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "시스템이 수행해야 하는 특정 기능이나 서비스에 대한 명세",
            },
            {
                "term": "인수 기준 (Acceptance Criteria)",
                "definition": "기능이 완료됐다고 판단하는 조건",
            },
            {
                "term": "SRS (Software Requirements Specification)",
                "definition": "소프트웨어 시스템의 요구사항을 체계적으로 기술한 문서",
            },
            {
                "term": "Given-When-Then",
                "definition": "테스트 시나리오를 전제조건-행동-기대결과 형식으로 기술하는 패턴",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "기능 외의 품질 속성 — 성능·보안·사용성·확장성 등",
            },
            {
                "term": "가용성 (Availability)",
                "definition": "시스템이 정상적으로 사용 가능한 시간의 비율",
            },
            {
                "term": "OWASP Top 10",
                "definition": "웹 애플리케이션의 주요 보안 취약점 10가지를 정리한 표준 목록",
            },
            {
                "term": "SLA (Service Level Agreement)",
                "definition": "서비스 제공자와 사용자 간에 합의된 서비스 품질 기준",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                "term": "MoSCoW 기법",
                "definition": "요구사항을 Must/Should/Could/Won't 4단계 우선순위로 분류하는 방법",
            },
            {
                "term": "RTM (Requirements Traceability Matrix)",
                "definition": "요구사항과 설계·구현·테스트를 연결해 추적하는 표",
            },
            {
                "term": "범위 크리프 (Scope Creep)",
                "definition": "통제되지 않은 요구사항 추가로 프로젝트 범위가 점차 확장되는 현상",
            },
            {
                "term": "기준선 (Baseline)",
                "definition": "공식적으로 합의·확정된 요구사항 버전",
            },
        ],
    },
    # ── Stage 4: 설계 ────────────────────────────────────────────────────
        ...
        "default_dictionary": [
            {
                ...
                "definition": "시스템의 주요 구성요소와 그 관계·원칙을 정의한 구조적 설계",
            },
            {
                "term": "3-Tier 아키텍처",
                "definition": "프레젠테이션·비즈니스 로직·데이터 계층으로 분리된 전통적 아키텍처",
            },
            {
                "term": "C4 모델",
                "definition": "Context·Container·Component·Code 4단계로 소프트웨어 아키텍처를 시각화하는 방법",
            },
            {
                "term": "ADR (Architecture Decision Record)",
                "definition": "아키텍처 결정 사항과 그 이유를 기록한 문서",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "데이터 엔티티와 그 관계를 시각화한 다이어그램",
            },
            {
                "term": "정규화 (Normalization)",
                "definition": "데이터 중복을 제거하고 일관성을 확보하기 위해 테이블을 분리하는 과정",
            },
            {
                "term": "외래키 (Foreign Key)",
                "definition": "다른 테이블의 기본키를 참조해 테이블 간 관계를 설정하는 컬럼",
            },
            {
                "term": "인덱스 (Index)",
                "definition": "데이터 검색 속도를 높이기 위해 특정 컬럼에 생성하는 자료구조",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                "term": "REST API",
                "definition": "HTTP 메서드(GET/POST/PUT/DELETE)로 자원을 다루는 웹 인터페이스 설계 원칙",
            },
            {
                "term": "와이어프레임 (Wireframe)",
                "definition": "화면의 정보 구조와 레이아웃을 간단하게 표현한 UI 스케치",
            },
            {
                "term": "OpenAPI (Swagger)",
                "definition": "REST API의 엔드포인트·파라미터·응답을 표준 형식으로 문서화하는 명세",
            },
            {
                "term": "목 서버 (Mock Server)",
                "definition": "실제 API 없이 정의된 스펙에 따라 가짜 응답을 반환하는 개발용 서버",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "개발 전 설계의 정확성·완전성·일관성을 검토하는 공식 점검 활동",
            },
            {
                "term": "워크스루 (Walkthrough)",
                "definition": "작성자가 문서·코드를 팀에게 설명하며 피드백을 받는 비공식 검토",
            },
            {
                "term": "기술 부채 (Technical Debt)",
                "definition": "빠른 개발을 위해 지름길을 선택할 때 나중에 갚아야 할 추가 작업",
            },
            {
                "term": "확장성 (Scalability)",
                "definition": "사용자·데이터 증가에 따라 시스템 성능을 유지하는 능력",
            },
        ],
    },
    # ── Stage 5: 개발 ────────────────────────────────────────────────────
    {
        ...
        "default_dictionary": [
            {
                "term": "Docker Compose",
                "definition": "여러 컨테이너로 구성된 애플리케이션을 하나의 YAML 파일로 정의·실행하는 도구",
            },
            {
                "term": ".env 파일",
                "definition": "환경변수를 파일로 관리하는 방식. DB 접속 정보·API 키 등을 코드에서 분리",
            },
            {
                "term": "스캐폴드 (Scaffold)",
                "definition": "프로젝트의 기본 디렉토리 구조와 설정 파일을 자동 생성하는 초기 뼈대",
            },
            {
                "term": ".gitignore",
                "definition": "Git이 추적하지 않을 파일·디렉토리를 지정하는 설정 파일",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "테스트를 먼저 작성하고 그 테스트를 통과하는 코드를 구현하는 개발 방식",
            },
            {
                "term": "비즈니스 로직",
                "definition": "애플리케이션의 핵심 규칙·처리 과정을 구현한 코드",
            },
            {
                "term": "Atomic Commit",
                "definition": "하나의 논리적 변경만 포함하는 최소 단위 커밋",
            },
            {
                "term": "리팩토링 (Refactoring)",
                "definition": "외부 동작을 바꾸지 않고 코드 내부 구조를 개선하는 활동",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "코드 변경을 자동으로 빌드·테스트하는 지속적 통합 프로세스",
            },
            {
                "term": "E2E 테스트 (End-to-End Test)",
                "definition": "사용자 시나리오 전체 흐름을 처음부터 끝까지 검증하는 테스트",
            },
            {
                "term": "머지 충돌 (Merge Conflict)",
                "definition": "두 브랜치가 같은 코드 부분을 다르게 수정해 자동 병합이 불가능한 상태",
            },
            {
                "term": "스테이징 환경 (Staging)",
                "definition": "프로덕션과 동일한 설정으로 배포 전 최종 검증하는 테스트 환경",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "다른 개발자가 작성한 코드를 읽고 오류·개선점을 찾는 활동",
            },
            {
                "term": "린터 (Linter)",
                "definition": "코드 스타일·문법 오류를 자동으로 검사하는 정적 분석 도구",
            },
            {
                "term": "단위 테스트 (Unit Test)",
                "definition": "개별 함수·모듈이 예상대로 동작하는지 검증하는 테스트",
            },
            {
                "term": "LGTM (Looks Good To Me)",
                "definition": "코드 리뷰에서 변경사항을 승인한다는 의미의 약어",
            },
        ],
    },
    # ── Stage 6: 테스트 및 검증 ──────────────────────────────────────────
    {
        ...
        "default_dictionary": [
            {
                "term": "테스트 피라미드",
                "definition": "단위·통합·E2E 테스트의 이상적인 비율을 피라미드 형태로 나타낸 전략",
            },
            {
                "term": "해피 패스 (Happy Path)",
                "definition": "오류 없이 정상적으로 진행되는 주요 사용 흐름",
            },
            {
                "term": "엣지 케이스 (Edge Case)",
                "definition": "경계값·예외 상황·비정상 입력 등 특수한 조건에서의 동작",
            },
            {
                "term": "픽스처 (Fixture)",
                "definition": "테스트 실행 전 준비하고 실행 후 정리하는 테스트 전용 데이터·환경",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "코드 변경 후 기존 기능이 여전히 정상 동작하는지 확인하는 테스트",
            },
            {
                "term": "탐색적 테스팅",
                "definition": "사전 스크립트 없이 직관과 경험으로 자유롭게 버그를 찾는 테스트 방식",
            },
            {
                "term": "부하 테스트 (Load Test)",
                "definition": "동시 사용자 증가 시 시스템 성능을 측정하는 테스트",
            },
            {
                "term": "테스트 커버리지 (Test Coverage)",
                "definition": "전체 코드 중 테스트가 실행된 비율",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                "term": "결함 (Defect/Bug)",
                "definition": "소프트웨어가 명세된 요구사항과 다르게 동작하는 문제",
            },
            {
                "term": "심각도 (Severity)",
                "definition": "결함이 시스템 기능에 미치는 영향의 정도",
            },
            {
                "term": "우선순위 (Priority)",
                "definition": "결함을 수정해야 하는 시급성",
            },
            {
                "term": "RCA (Root Cause Analysis)",
                "definition": "문제의 근본 원인을 체계적으로 분석하는 방법",
            },
        ],
    },
    {
        ...
        "default_dictionary": [
            {
                ...
                "definition": "실제 사용자가 시스템이 요구사항을 충족하는지 직접 검증하는 최종 테스트",
            },
            {
                "term": "회고 (Retrospective)",
                "definition": "프로젝트나 스프린트를 마친 후 팀이 개선점을 논의하는 성찰 활동",
            },
            {
                "term": "릴리즈 노트 (Release Notes)",
                "definition": "새 버전에 포함된 기능·수정·알려진 이슈를 정리한 공식 문서",
            },
            {
                "term": "Done의 정의 (Definition of Done)",
                "definition": "작업이 완료됐다고 판단하는 팀 내 합의된 기준",
            },
        ],
    },
]
